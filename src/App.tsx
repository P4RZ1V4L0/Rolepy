    ...
    <div className="flex h-screen w-full bg-zinc-950 overflow-hidden">
      ...
      <main className={cn(
        ...
        {selectedCharacter ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-[#0b141a] relative overflow-hidden">
            <div className="whatsapp-bg" />
            <div className="z-10 flex flex-col items-center">
              <div className="w-24 h-24 bg-[#202c33] rounded-3xl flex items-center justify-center mb-6 border border-zinc-800 shadow-2xl rotate-3">
                <MessageSquare size={48} className="text-[#00a884] -rotate-3" />
              </div>
              <h2 className="text-3xl font-bold text-zinc-100 mb-2 font-serif">Roleplay Studio</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg">
                <div className="p-4 bg-[#1c1c1e] border border-zinc-800/50 rounded-2xl text-left shadow-sm">
                ...
                <div className="p-4 bg-[#1c1c1e] border border-zinc-800/50 rounded-2xl text-left shadow-sm">
                  <div className="w-8 h-8 bg-[#00a884]/10 rounded-lg flex items-center justify-center mb-3">
